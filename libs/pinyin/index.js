 ...
 * @start 2016-09-26
 * @last 2016-09-29
 * @link http://www.cnblogs.com/liuxianan/p/pinyinjs.html
 */
const dic = require('./firstLetter')
...
const pinyin = (function() {
    ...
    var pinyinUtil = {
        ...
        parseDict: function() {
            ...
            if (dic.pinyin_dict_firstletter) {
                dict.firstletter = dic.pinyin_dict_firstletter;
            }
            // 如果导入了 pinyin_dict_notone.js
            if (dic.pinyin_dict_notone) {
                dict.notone = {};
                dict.py2hz = dic.pinyin_dict_notone; // 拼音转汉字
                for (var i in dic.pinyin_dict_notone) {
                    var temp = dic.pinyin_dict_notone[i];
            ...
            if (dic.pinyin_dict_withtone) {
                dict.withtone = {};
                var temp = dic.pinyin_dict_withtone.split(',');
                ...
                if (dic.pinyin_dict_notone) {
                    ...
                    var notone = pinyinUtil.removeTone(dic.pinyin_dict_withtone).split(',');
                    var py2hz = {},
                        py, hz;
        ...
        getPinyin: function(chinese, splitter, withtone, polyphone) {
            ...
            if (!polyphone) return result.join(splitter);
                ...
                if (dic.pinyin_dict_polyphone) return parsePolyphone(chinese, result, splitter, withtone);
    ...
    function parsePolyphone(chinese, result, splitter, withtone) {
        var poly = dic.pinyin_dict_polyphone;
